...
type Platform = 'github' | 'linkedin' | 'gmail';
...
// Same paths already used in AchievementsPage's closing section — pulled out
// here so both places render identical, real vector icons instead of text.
